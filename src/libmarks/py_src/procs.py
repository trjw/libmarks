...
class ExplainProcess(object):
    ...
    def readline_stderr(self, **kwargs):
        if 'explain' in kwargs:
            ...
            self._print_coloured(
                'Read line from stderr of Process {0}'.format(self.count),
                attrs=['bold'], end='\n')
        return ''
    ...
    def readline_stdout(self, **kwargs):
        if 'explain' in kwargs:
            ...
            self._print_coloured(
                'Read line from stdout of Process {0}'.format(self.count),
                attrs=['bold'], end='\n')
        return ''
    ...
    def print_stdout(self, **kwargs):
        if 'explain' in kwargs:
            ...
            self._print_coloured(
                'Dump the remainer of stdout ofof Process {0}: '.format(self.count),
                attrs=['bold'], end='')            
        pass
    ...
    def print_stderr(self, **kwargs):
        if 'explain' in kwargs:
            ...
            self._print_coloured(
                'Dump the remainder of stderr of Process {0}: '.format(self.count),
                attrs=['bold'], end='')            
        pass
    ...
    def assert_exit_status(self, status, **kwargs):
        ...
        # Print out the signal being sent to the process.
        self._print_coloured(
            "Exit status for Process {0}: {1}?".format(self.count, 
                status),
                attrs=['bold'], end='\n')
    ...
    def assert_signalled(self, tf, **kwargs):
        ...
        # Print out the signal being sent to the process.
        self._print_coloured(
            "Process {0} was signalled: {1}?".format(self.count, 
                tf),
                attrs=['bold'], end='\n')
    ...
    def assert_signal(self, sig, **kwargs):
        ...
        # Print out the signal being sent to the process.
        self._print_coloured(
            "Did Process {0} receive signal {1}?".format(self.count, 
                sig),
                attrs=['bold'], end='\n')
    ...
    def kill(self, **kwargs):
        ...
        # Print out the signal being sent to the process.
        self._print_coloured(
            "Kill Process {0}.".format(self.count),
                attrs=['bold'], end='\n')
    ...
    def check_signalled(self, **kwargs):
        ...
        # Print out the signal being sent to the process.
        self._print_coloured(
            "Was Process {0} signalled?".format(self.count),
                attrs=['bold'], end='\n')
