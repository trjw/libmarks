...
BOOST_PYTHON_MODULE(process)
{
    ...
    class_<Process>("Process", "Process class docstring", init<std::vector<std::string> >(args("argv")))
        ...
        .add_property("timeout", &Process::get_timeout)
    ...
    class_<TimeoutProcess>("TimeoutProcess", "Timeout Process class docstring", init<std::vector<std::string>, int>(args("argv", "timeout")))
